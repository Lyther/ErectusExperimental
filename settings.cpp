...
ScrapLooterSettings defltScrapLooterSettings
{
	...
	.nameList = {
		...
		(const char*)u8"Ê¯ÃÞ",//0x0001FA97
		(const char*)u8"¹ÇÍ·",//0x0001FA98
		(const char*)u8"ÌÕ´É",//0x0001FA9A
		(const char*)u8"µçÂ·Ôª¼þ",//0x0001FA9B
		...
		(const char*)u8"ð¤ºÏ¼Á",//0x0001FAA5
		(const char*)u8"½ð",//0x0001FAA6
		...
		(const char*)u8"´¿¾»ÐÉºìÉ«ÈÜ¼Á",//0x002B917E
		(const char*)u8"´¿¾»»Æ±ýÈÜ¼Á",//0x002B9180
...
HarvesterSettings harvesterDefaults
{
	...
	.nameList = {
		(const char*)u8"ÐÉºìÉ«ÈÜ¼ÁÔ­ÁÏ",
		(const char*)u8"îÜÀ¶É«ÈÜ¼ÁÔ­ÁÏ",
		(const char*)u8"»Æ±ýÈÜ¼ÁÔ­ÁÏ",
		...
		(const char*)u8"»ìÄýÍÁËéÆ¬",
		(const char*)u8"·ÏÓÍ",
		(const char*)u8"·ÏËá",
		(const char*)u8"Ë®¾§ËéÆ¬",
		(const char*)u8"·ÊÁÏÔ­ÁÏ",
		(const char*)u8"ÂûÔ½Ý®",
		(const char*)u8"È¾²¡µÄÂûÔ½Ý®",
		(const char*)u8"ËþÝ®",
		(const char*)u8"±¬Öñ½¬¹û",
		(const char*)u8"Ò°¹Ï»¨",
		(const char*)u8"ÁåÊí»¨",
		...
		(const char*)u8"×ÏÔ·",
		(const char*)u8"¿ÝÎ®µÄ¹½Àà",
		(const char*)u8"¿ñÈÈ»¨",
		(const char*)u8"Kaleidopore Flower",
		(const char*)u8"»Ò½ýÃµ¹å",
